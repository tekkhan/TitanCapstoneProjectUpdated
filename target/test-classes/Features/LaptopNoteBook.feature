...
When User click on Laptop and NoteBook option
...
Given User is on Retail website
When User click on Laptop and NoteBook optoin
...
Given User is on Retail website
When User click on Laptop adn NoteBook tab
And User click on show all Laptop adn NoteBook option
...
@laptop3
Scenario: Validate teh price of MacBook Pro IS 2000
Given User is on Retail website
